...
GAIN_CONFIG="/home/r1lite/Documents/FastWAM/experiments/r1lite/joint_controller_kp_kd_fastwam.toml"
...
if [[ ! -f "$GAIN_CONFIG" ]]; then
    echo "Missing gain configuration: $GAIN_CONFIG" >&2
    exit 1
fi
...
echo "Starting the joint tracker with FastWAM gains..."
...
echo "Expected right-arm Kp: [140, 230, 132, 80, 80, 80]"
